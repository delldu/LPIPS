...
class squeezenet(nn.Module):
    def __init__(self):
        ...
        pretrained_features = M.squeezenet1_1(pretrained=True).features
...
class alexnet(nn.Module):
    def __init__(self):
        ...
        alexnet_pretrained_features = M.alexnet(pretrained=True).features
        self.slice1 = nn.Sequential()
        self.slice2 = nn.Sequential()
        self.slice3 = nn.Sequential()
        self.slice4 = nn.Sequential()
...
class vgg16(nn.Module):
    def __init__(self):
        ...
        vgg_pretrained_features = M.vgg16(pretrained=True).features
        self.slice1 = nn.Sequential()
        self.slice2 = nn.Sequential()
        self.slice3 = nn.Sequential()
        self.slice4 = nn.Sequential()
